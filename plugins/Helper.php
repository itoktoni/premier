...
class Helper
{
    ...
    public static function getMethod($class, $module = false)
    {
        ...
        // dd($reflector);
        // $bar_methods = array_diff(get_class_methods($class), get_class_methods('app\Http\Controllers\System\MasterController.php'));
        // dd($bar_methods);
    ...
    public static function getFunction($class, $module)
    {
        $function = get_class_methods($class);
        $methodNames = [];
        $unset = [
